...
TextView signin,admin_btn,fpass,doc;
    Button login;
EditText uph,passok;
String a,b,c,d,e,f,g;
   ...
   doc = findViewById(R.id.docter_btn);
            ...
            if (uph.getText().toString().isEmpty())
              {
               ...
               passok.setError("enter a avlid phone  password");
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://androidprojectstechsays.000webhostapp.com/Hospital_Manegument_system/user_login.php",
